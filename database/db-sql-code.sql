...
ADD CONSTRAINT fk_account FOREIGN KEY (account_id) REFERENCES public.account (account_id) ON UPDATE CASCADE ON DELETE NO ACTION;
-- Create relationship between 'inventory' and 'review' tables
ALTER TABLE IF EXISTS public.review
ADD CONSTRAINT fk_inventory FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) ON UPDATE CASCADE ON DELETE NO ACTION;
